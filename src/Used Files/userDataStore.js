// userDataStore.js
// Secure user data storage for FitBuddy (Node.js server-side)
...
const ENCRYPTION_KEY = process.env.FITBUDDY_USERDATA_KEY || 'fitbuddy_default_key_32bytes!'; // 32 bytes for AES-256
const IV_LENGTH = 16;
