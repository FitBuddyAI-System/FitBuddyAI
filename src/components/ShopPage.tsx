...
// Example shop items
const AVATARS = [
  { id: 'avatar1', name: 'Bot Buddy', image: 'https://api.dicebear.com/7.x/bottts/svg?seed=FitBuddy1', price: 100, type: 'avatar', description: 'A friendly robot avatar.' },
...
const POWERUPS = [
  ...
  { id: 'badge-pro', name: 'Pro Badge', icon: <Smile size={32} color="#1ecb7b" />, price: 190, type: 'powerup', description: 'Show you are a FitBuddy Pro.' },
  ...
  return (
    <div className="shop-page fade-in-bounce">
      <header className="shop-header">
        ...
        <h1 className="shop-title gradient-text">FitBuddy Shop</h1>
