...
export default function PrivacyPage() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('fitbuddyaiai-privacy-accepted', onAccepted);
    return () => window.removeEventListener('fitbuddyaiai-privacy-accepted', onAccepted);
  }, []);
    ...
    <div className="terms-page">
      <header className="terms-hero">
        <div className="terms-hero-inner">
          ...
          <div>
            <h1 className="hero-title">FitBuddyAIAI Privacy Policy</h1>
      ...
      <section className="terms-full">
        <div className="terms-full-inner">
          ...
          <p>This Privacy Policy explains how FitBuddyAIAI, LLC collects, uses, discloses, and protects the personal information of users of the Service. By using the Service you consent to the collection and use of information as described in this policy.</p>
