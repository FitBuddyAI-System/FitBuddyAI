...
export default function TermsPage() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('fitbuddy-tos-accepted', onAccepted);
    return () => window.removeEventListener('fitbuddy-tos-accepted', onAccepted);
  }, []);
  ...
  const onAccept = () => {
    ...
    try {
      ...
      if (userId) {
        import('../services/apiAuth').then(m => m.attachAuthHeaders({ method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ userId, accepted_terms: true }) })).then(init => fetch('/api/userdata/save', init)).catch(()=>{});
      }
    } catch (e) {}
  };
    ...
    <div className="terms-page">
      <header className="terms-hero">
        <div className="terms-hero-inner">
          ...
          <div>
            <h1 className="hero-title">FitBuddy Terms of Service</h1>
      ...
      <main className="terms-container">
        <article className="terms-card">
          ...
          <p>FitBuddy provides workout suggestions and educational material to help you train safely. This is not medical advice. If you have a medical condition, please consult a healthcare professional before acting on any exercise recommendation.</p>
        </article>
        ...
        <article className="terms-card">
          <h2>4. Liability</h2>
          <p>By using FitBuddy you acknowledge that you are voluntarily participating in physical activity and accept responsibility for any risks. We are not liable for injuries caused while following the app.</p>
        </article>
      ...
      <section className="terms-full">
        <div className="terms-full-inner">
          ...
          <h3>1. Definitions</h3>
          <p>"Content" means any information, text, graphics, images, audio, video, code, algorithms, workout plans, recommendations, comments, and other materials provided by FitBuddy or Users. "User Content" means Content submitted or transmitted by Users. "Personal Data" means information that identifies or can be used to identify an individual, subject to the Privacy Policy.</p>

          <h3>2. Scope of Service</h3>
          <p>FitBuddy provides fitness and wellness related guidance, educational materials, personalized workout plans, and software tools. The Service may include content generated or assisted by artificial intelligence. The Service is provided on an "as is" and "as available" basis. FitBuddy reserves the right to modify, suspend, or discontinue any aspect of the Service at any time without prior notice.</p>
          ...
          <p>FitBuddy and its licensors retain all right, title, and interest in and to the Service and Content provided by FitBuddy, including intellectual property rights. Users are granted a limited, non-exclusive, non-sublicensable, revocable license to access and use the Service for personal, non-commercial purposes in accordance with this Agreement. Users shall not reproduce, distribute, modify, create derivative works, reverse engineer, or otherwise exploit FitBuddy's intellectual property except as expressly authorized herein.</p>

          <h3>7. User Content and License to FitBuddy</h3>
          <p>By submitting User Content, Users grant FitBuddy a worldwide, royalty-free, sublicensable, transferable, perpetual, irrevocable license to use, host, store, reproduce, modify, create derivative works, communicate, publish, and distribute such User Content for the purposes of operating, improving, and promoting the Service. Users warrant that they have the rights to grant such license and that User Content does not violate third-party rights.</p>
          ...
          <p>The Service may contain links to third-party websites, services, or content. FitBuddy does not endorse and is not responsible for third-party offerings, practices, or privacy policies. Users access third-party resources at their own risk and should review the third-party terms and privacy policies.</p>

          <h3>10. Privacy and Data</h3>
          <p>Use of Personal Data is governed by FitBuddy’s Privacy Policy. By using the Service, Users consent to FitBuddy’s collection, processing, storage, and transfer of Personal Data in accordance with the Privacy Policy. FitBuddy will take commercially reasonable measures to secure User Data but cannot guarantee absolute security.</p>
          ...
          <p>FitBuddy may update these Terms from time to time. We will provide notice of material changes, for example by email to registered accounts or prominent notice within the Service. Continued use of the Service after changes constitute acceptance of the revised Terms.</p>
