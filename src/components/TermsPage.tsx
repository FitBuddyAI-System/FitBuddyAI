...
export default function TermsPage() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('fitbuddyaiai-tos-accepted', onAccepted);
    return () => window.removeEventListener('fitbuddyaiai-tos-accepted', onAccepted);
  }, []);
    ...
    <div className="terms-page">
      <header className="terms-hero">
        <div className="terms-hero-inner">
          ...
          <div>
            <h1 className="hero-title">FitBuddyAIAI Terms of Service</h1>
      ...
      <main className="terms-container">
        <article className="terms-card">
          ...
          <p>FitBuddyAIAI provides workout suggestions and educational material to help you train safely. This is not medical advice. If you have a medical condition, please consult a healthcare professional before acting on any exercise recommendation.</p>
        </article>
        ...
        <article className="terms-card">
          <h2>4. Liability</h2>
          <p>By using FitBuddyAIAI you acknowledge that you are voluntarily participating in physical activity and accept responsibility for any risks. We are not liable for injuries caused while following the app.</p>
        </article>
      ...
      <section className="terms-full">
        <div className="terms-full-inner">
          ...
          <p>The Service provides general fitness information and recommendations which are not a substitute for professional medical advice, diagnosis, or treatment. Users should consult a qualified healthcare professional before beginning any exercise program or if they have health concerns. By using the Service, Users acknowledge and assume all risks associated with participating in physical activity and agree that FitBuddyAIAI is not responsible for any injury, loss, or damage arising from use of the Service.</p>

          <h3>5. AI-Generated Content and Accuracy</h3>
          <p>Some Content may be generated or assisted by machine learning models, third‑party APIs, or algorithmic systems. While FitBuddyAIAI strives for accuracy and utility, AI outputs may be incomplete, imprecise, or contextually inappropriate. FitBuddyAIAI disclaims any warranty regarding the suitability, reliability, or accuracy of AI-generated Content. Reliance on such Content is at the User's own risk.</p>

          <h3>6. Intellectual Property</h3>
          <p>FitBuddyAIAI and its licensors retain all right, title, and interest in and to the Service and Content provided by FitBuddyAIAI, including intellectual property rights. Users are granted a limited, non-exclusive, non-sublicensable, revocable license to access and use the Service for personal, non-commercial purposes in accordance with this Agreement. Users shall not reproduce, distribute, modify, create derivative works, reverse engineer, or otherwise exploit FitBuddyAIAI's intellectual property except as expressly authorized herein.</p>

          <h3>7. User Content and License to FitBuddyAIAI</h3>
          <p>By submitting User Content, Users grant FitBuddyAIAI a worldwide, royalty-free, sublicensable, transferable, perpetual, irrevocable license to use, host, store, reproduce, modify, create derivative works, communicate, publish, and distribute such User Content for the purposes of operating, improving, and promoting the Service. Users warrant that they have the rights to grant such license and that User Content does not violate third-party rights.</p>
          ...
          <p>The Service may contain links to third-party websites, services, or content. FitBuddyAIAI does not endorse and is not responsible for third-party offerings, practices, or privacy policies. Users access third-party resources at their own risk and should review the third-party terms and privacy policies.</p>

          <h3>10. Privacy and Data</h3>
          <p>Use of Personal Data is governed by FitBuddyAIAI’s Privacy Policy. By using the Service, Users consent to FitBuddyAIAI’s collection, processing, storage, and transfer of Personal Data in accordance with the Privacy Policy. FitBuddyAIAI will take commercially reasonable measures to secure User Data but cannot guarantee absolute security.</p>

          <h3>11. Warranties and Disclaimers</h3>
          <p>EXCEPT AS EXPRESSLY PROVIDED HEREIN, THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND. FITBUDDYAIAI DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT. FITBUDDYAIAI DOES NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED, ERROR-FREE, OR SECURE.</p>

          <h3>12. Limitation of Liability</h3>
          <p>TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL FITBUDDYAIAI, ITS AFFILIATES, LICENSORS, OR SERVICE PROVIDERS BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR FOR LOSS OF PROFITS, REVENUE, DATA, OR USE, ARISING OUT OF OR IN CONNECTION WITH THE SERVICE, WHETHER IN CONTRACT, TORT (INCLUDING NEGLIGENCE), STRICT LIABILITY, OR OTHERWISE, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. FITBUDDYAIAI'S AGGREGATE LIABILITY FOR DIRECT DAMAGES SHALL NOT EXCEED THE AMOUNTS PAID BY THE USER TO FITBUDDYAIAI IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM, OR ONE HUNDRED DOLLARS (USD $100), WHICHEVER IS GREATER.</p>

          <h3>13. Indemnification</h3>
          <p>Users agree to indemnify, defend, and hold harmless FitBuddyAIAI and its officers, directors, employees, agents, and affiliates from and against any and all losses, liabilities, claims, demands, damages, costs, and expenses (including reasonable attorneys’ fees) arising out of or relating to: (a) User's breach of this Agreement; (b) User’s violation of any law or third-party rights; or (c) User Content.</p>
          ...
          <p>This Agreement shall be governed by and construed in accordance with the laws of the state in which FitBuddyAIAI is incorporated, without regard to conflict of laws principles. Any dispute arising out of or related to this Agreement shall be resolved exclusively through final and binding arbitration, except where prohibited by law. The arbitrator's decision will be final and binding and may be entered as a judgment in any court of competent jurisdiction.</p>

          <h3>16. Changes to Terms</h3>
          <p>FitBuddyAIAI may update these Terms from time to time. We will provide notice of material changes, for example by email to registered accounts or prominent notice within the Service. Continued use of the Service after changes constitute acceptance of the revised Terms.</p>

          <h3>17. Miscellaneous</h3>
          <p>This Agreement, together with the Privacy Policy and any other legal notices published by FitBuddyAIAI, constitutes the entire agreement between the parties concerning the subject matter herein. If any provision is found unenforceable, the remaining provisions will remain in full force. Failure to enforce a right is not a waiver of that right.</p>
